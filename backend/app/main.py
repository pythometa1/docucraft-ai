...
from app.routers import admin, auth, bindings, blueprints, chat, downloads, generation, invoices, manifests, metrics, projects, review, reviews, sources, templates
...
app.include_router(invoices.router, prefix="/api/v1", dependencies=_rate_limited)  # the invoice service: client book, numbering, registry
