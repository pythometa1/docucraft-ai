...
# ---------------------------------------------------------------------------
# The invoice service (the first per-industry vertical).
#
...
# of its own, a registry table. Invoices have one: an invoice is not just a
# generated document, it is a numbered, customer-addressed, money-bearing
# record the organisation will be asked about at tax time.
# ---------------------------------------------------------------------------
